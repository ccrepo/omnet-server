...
/**
 * This class implements an OKTA User properties values service bean.
 * 
 * @author cc
 * @version %I%, %G%
 * @since 0.1
 */
@Component
public class OktaUserProperties extends OktaProperties {

  private final static String prefix = "okta-user";
   ...
   */
  public OktaUserProperties(OAuth2ClientProperties properties) {
